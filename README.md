...
| billing\_account\_id | The alphanumeric ID of the billing account this project belongs to. | `string` | `null` | no |
...
| folder\_id | The numeric ID of the folder this project should be created under. | `string` | `null` | no |
...
| org\_id | The numeric ID of the organization this project belongs to. | `string` | `null` | no |
